...
class Config:
    ...
    SUPPORT_USERNAME = os.getenv("SUPPORT_USERNAME", "@smknnnn")
    ...
    IMAGE_GENERATION_MODEL = "google/gemma-3-4b-it"

    # AI Models with emojis and media support
    AI_MODELS = {
        "free": [
            {"id": "google/gemma-3-4b-it", "name": "🧠 Gemma 3 4B", "name_en": "🧠 Gemma 3 4B", 
             ...
             "supports_images": True, "supports_video": False, "supports_audio": False, "emoji": "😊"},
        ],
        "lite": [
            {"id": "openai/gpt-oss-20b", "name": "🔓 GPT-OSS-20B", "name_en": "🔓 GPT-OSS-20B",
             ...
             "input": "Текст", "output": "Текст", "supports_images": False, "supports_video": False, "supports_audio": False, "emoji": "🤔"},
        ],
        "lite_plus": [
            {"id": "google/gemini-2.0-flash-lite-001", "name": "⚡ Gemini 2.0 Flash", "name_en": "⚡ Gemini 2.0 Flash",
             ...
             "input": "Текст, Изображения, Аудио, Видео", "output": "Текст", "supports_images": True, "supports_video": True, "supports_audio": True, "emoji": "⚡"},
        ],
        "vip": [
            {"id": "bytedance-seed/seed-1.6-flash", "name": "🎬 Seed 1.6 Flash", "name_en": "🎬 Seed 1.6 Flash",
             ...
             "input": "Текст, Изображения, Видео", "output": "Текст", "supports_images": True, "supports_video": True, "supports_audio": False, "emoji": "🎬"},
        ],
        "vip_plus": [
            {"id": "openai/gpt-5-image-mini", "name": "🖼️ GPT-5 Image Mini", "name_en": "🖼️ GPT-5 Image Mini",
             ...
             "input": "Текст, Изображения", "output": "Текст, Изображения", "supports_images": True, "supports_video": False, "supports_audio": False, "emoji": "🖼️"},
        ],
        "quantum": [
            {"id": "google/gemini-2.5-flash-image", "name": "🎨 Nano Banana", "name_en": "🎨 Nano Banana",
             ...
             "input": "Текст, Изображения", "output": "Текст, Изображения", "supports_images": True, "supports_video": False, "supports_audio": False, "emoji": "🎨"},
        ],
        "quantum_pro": [
        ...
        "quantum_infinite": [
            ...
            {"id": "openai/o1-pro", "name": "👑 o1-pro", "name_en": "👑 o1-pro",
             ...
             "input": "Текст, Изображения", "output": "Текст", "supports_images": True, "supports_video": False, "supports_audio": False, "emoji": "👑"},
        ],
    ]
    ...
    SUBSCRIPTION_PLANS = [
        ...
        {"id": "lite_plus", "name": "💎 Lite+", "name_en": "💎 Lite+", "price": 399, 
         "daily_limit": 350, "image_send": 10, "image_generate": 5, "video_send": 4},
         
        {"id": "vip", "name": "⭐ VIP", "name_en": "⭐ VIP", "price": 1499, 
         "daily_limit": 500, "image_send": 15, "image_generate": 7, "video_send": 7},
         
        {"id": "vip_plus", "name": "🎨 VIP+", "name_en": "🎨 VIP+", "price": 4999, 
         "daily_limit": 1000, "image_send": 30, "image_generate": 10, "video_send": 10},
         
        {"id": "quantum", "name": "🚀 Quantum", "name_en": "🚀 Quantum", "price": 19999, 
         "daily_limit": 2000, "image_send": 50, "image_generate": 30, "video_send": 15},
         
        {"id": "quantum_pro", "name": "🔬 Quantum Pro", "name_en": "🔬 Quantum Pro", "price": 49999, 
         "daily_limit": 5000, "image_send": 100, "image_generate": 60, "video_send": 22},
